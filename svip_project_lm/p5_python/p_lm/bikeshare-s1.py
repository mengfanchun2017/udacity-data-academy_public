...
def get_filters():
    ...
    while month not in mon_option:   
        month = input ('Q2: which month do you want to explore? choose from all, january, february, ... , june?>').lower()     
              
   
    # TO DO: get user input for day of week (all, monday, tuesday, ... sunday)
    day_option = ['monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday']
    while True:  
        day = input ('Q3: which day do you want to explore? choose from all, monday, tuesday, ... , sunday. >').lower()               
