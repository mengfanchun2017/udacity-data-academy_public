# -*- coding: utf-8 -*-
"""
Created on Sun Mar 10 00:24:35 2019
...
def input_mod(input_print,option_list):
    ...
    while True:
        user_input = input(input_print).lower()
...
def get_filters():
    ...
    city_input = 'Q1:which city do you want to know? chicago, new york city, washingtion? >'
    
    # TO DO: get user input for month (all, january, february, ... , june)
    month_input = 'Q2: which month do you want to know? all, january, february, ... june? >'

    # TO DO: get user input for day of week (all, monday, tuesday, ... sunday)
    day_input = 'Q3: which day do you want to know? all, monday, tuesday, ... sunday? > '
    
    city = input_mod(city_input, city_option)
    month = input_mod(month_input, month_option)
    day = input_mod(day_input, day_option)
