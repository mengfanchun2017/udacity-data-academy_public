# -*- coding: utf-8 -*-
"""
Created on Thu Mar  7 21:24:32 2019
...
def get_filters():
    ...
    while True:
        city = input('Q1:which city do you want to know? chicago, new york city, washingtion? >').lower()
    ...
    while True:
        month = input('Q2: which month do you want to know? all, january, february, ... june? >')
    ...
    while True:
        day = input('Q3: which day do you want to know? all, monday, tuesday, ... sunday? > ')
